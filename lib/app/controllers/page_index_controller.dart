...
class PageIndexController extends GetxController {
    ...
    switch (i) {
      case 1:
        ...
        if (dataResponse["error"] != true) {
          ...
          String address = "${placemarks[0].name}, ${placemarks[0].subLocality}, ${placemarks[0].locality}";
          await updatePosition(position, address);

          //cek distance between 2 position
          double distance = Geolocator.distanceBetween(-6.919518, 107.649615, position.latitude, position.longitude);
          // presensi
            ...
            actions: [
              ...
              ElevatedButton(
                onPressed: () async {
                  ...
                  Get.back();
                  Get.snackbar("Berhasil", "daftar hadir (KELUAR)");
                },
                child: Text("YES"),
              ),
            ],
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                Get.back();
                Get.snackbar("Berhasil", " daftar hadir (MASUK)");
              },
              child: Text("YES"),
            ),
          ],
  ...
  Future<Map<String, dynamic>> determinePosition() async {
    ...
    if (permission == LocationPermission.deniedForever) {
      ...
      return {
        "message": "Settingan hp kamu tidak memperbolehkan untuk mengakses GPS. Ubah pada settingan hp kamu.",
        "error": true,
      };
