    ...
    if (passAdminC.text.isNotEmpty) {
      ...
      try {
        ...
        if (e.code == 'weak-password') {
          ...
          Get.snackbar("Terjadi Kesalahan", "Pegawai sudah ada. Kamu tidak dapat menambahkan pegawai dengan email ini.");
        ...
        actions: [
          ...
          Obx(
            () => ElevatedButton(
              ...
              child: Text(isLoadingAddPegawai.isFalse ? "ADD PEGAWAI" : "LOADING.."),
            ),
          ),
        ],
      );
